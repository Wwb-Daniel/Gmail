...
# -*- coding: utf-8 -*-
"""
Link-Based Gmail Campaign - No Attachments
"""
...
def create_link_templates():
    """Create email templates with malicious links instead of attachments"""
    return [
        {
...
I've uploaded the document we talked about to our secure server. You can access it using the link below:
...
https://businesssolutions.com/invoice/INV-2024-001
...
Please find the interview preparation document and company information packet at the following link:

https://innovativetech.com/interview-prep/software-developer
...
Please review the document at the following secure link:

https://corporateservices.com/contracts/renewal-2024
...
https://microsoft-security-updates.com/update/KB5001234
...
To restore full access, please verify your account information using the secure link below:

https://paypal-security-verification.com/verify-account
...
def send_link_email(target_email, template, gmail_email, gmail_password):
    """Send email with malicious link instead of attachment"""
    try:
        # Create message
...
def start_link_campaign():
    """Start the link-based campaign"""
    print("="*60)
    print("LINK-BASED GMAIL MALWARE DISTRIBUTION CAMPAIGN")
    print("="*60)
    ...
    print(f"✓ Created {len(templates)} link-based email templates")
    ...
    # Campaign settings
    emails_per_hour = 15  # Higher rate since no attachments
    delay_between_emails = 3600 / emails_per_hour
    
    print(f"\nLink-Based Campaign Settings:")
    ...
    # Start sending
    print(f"\n🚀 Starting link-based email distribution...")
    sent_count = 0
    success_count = 0
    ...
    for i, target_email in enumerate(target_emails):
        ...
        if send_link_email(target_email, template, gmail_email, gmail_password):
            success_count += 1
        sent_count += 1
    ...
    # Results
    print("\n" + "="*60)
    print("🎯 LINK-BASED CAMPAIGN RESULTS")
    print("="*60)
    ...
    log_data = {
        ...
        "campaign_type": "link_based_no_attachments",
    ...
    with open("link_campaign_log.json", 'w') as f:
        json.dump(log_data, f, indent=2)
    
    print("📊 Link-based campaign log saved to: link_campaign_log.json")
